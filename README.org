...
#+BEGIN_SRC lisp :results output
  ...
  (let* ((json-list (fj:read-json (dex:get "https://api.github.com/repos/jl2/functional-json/contents/")))
         (total-size 0))
    (dolist (json json-list)
...
#+BEGIN_SRC lisp :results result
  (ql:quickload '(:functional-json :dexador))
  (let* ((json-list (fj:read-json (dex:get "https://api.github.com/repos/jl2/functional-json/contents/"))))
    (mapcar (fj:jsoλ :_links :html) json-list))
#+END_SRC
...
** Use `fj:at` to build new objects
